            ...
            <div className='w-max flex items-center gap-2'>
              ...
              {!isGuest && user && user.id !== post?.author._id && (
                <button
                  ...
                  className={`${isGuest ? '!active:scale-[1] cursor-not-allowed hover:!bg-slate-300 bg-slate-300 !text-gray-400' : ''} rounded-md md:rounded-xl hidden md:flex items-center gap-1.5 px-3 py-1.5 h-[36px] text-xs font-medium transition ${
                    isFollowing
