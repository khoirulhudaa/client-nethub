...
const Sidebar = ({ onNavigate }) => {
  ...
  return (
    ...
    >
      ...
      <img src="/hero.jpg" alt="wallpaper-sidebar" className="rotate-[4deg] scale-[1.5] w-full h-screen dark:flex hidden object-cover absolute z-0 top-0 opacity-5 left-0" />
