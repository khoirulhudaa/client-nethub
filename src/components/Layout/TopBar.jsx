...
const TopBar = ({ onMenuClick }) => {
  ...
  return (
    <header className="w-full dark:bg-transparent surface-card h-[8.6vh] sticky top-0 z-[999] border-r border-white/10 flex items-center gap-3 py-0 rounded-none border-b px-1.5 md:px-3.5">
      <div
      ...
      <div className="w-[100%] flex justify-between h-full items-center pl-2 pr-4 md:pr-5">
        ...
        <form data-tour="search" onSubmit={handleSearch} className="relative w-full md:flex hidden max-w-md">
          ...
          <input
            ...
            className="input-field-transparent border border-slate-400 dark:border-white/20 pl-9"
          />
        </form>
