...
const TopBar = ({ onMenuClick }) => {
  ...
  return (
    <header className="w-full surface-card h-[8.6vh] sticky top-0 z-[99999] border-r border-white/10 flex items-center gap-3 py-0 rounded-none border-b px-1.5 md:px-3.5">
      <div
