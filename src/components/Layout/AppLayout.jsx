...
const AppLayout = () => {
  ...
  return (
    <div className="relative flex h-screen overflow-hidden bg-surface-light text-[#1D1D1F] dark:bg-surface-dark dark:text-[#F5F5F7]">
      ...
      <img src="/hero.jpg" alt="wallpaper-sidebar" className="absolute top-0 left-[0px] w-screen h-screen rotate-[0deg] scale-[2] w-full h-screen dark:flex hidden object-cover absolute z-0 top-0 opacity-15 left-0" />
